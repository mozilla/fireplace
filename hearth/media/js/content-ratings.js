define('content-ratings', ['format', 'l10n', 'urls', 'utils', 'z'],
    ...
    var descriptor_icons = {
        'pegi': {
            ...
            'sex-content': _rating_path('descriptors/pegi_sex.png'),
    ...
    var names = {
        ...
        descriptors: {
            ...
            usk: {
                // German.
                'abstract-violence': 'Abstrakte Gewalt',
                'alcohol': 'Alkoholkonsum',
                'discrimination': 'Diskriminierung',
                'drug_use': 'Drogenkonsum',
                'drugs': 'Drogen',
                'explicit-violence': 'Explizite Gewalt',
                'horror': 'Grusel/Horror',
                'lang': 'Explizite Sprache',
                'nudity': 'Nacktheit/Erotik',
                'scary': '\xC4ngstigende Inhalte',
                'sex-content': 'Erotik/Sexuelle Inhalte',
                'sex-ref': 'Sexuelle Andeutungen',
                'sex-violence': 'Sexuelle Gewalt',
                'sex-violence_ref': 'Andeutungen Sexueller Gewalt',
                'some-scares': 'Seltene Schreckmomente',
                'some-swearing': 'Gelegentliches Fluchen',
                'tobacco': 'Tabakkonsum',
                'violence': 'Gewalt',
            }
        },
