define('content-ratings', ['format', 'l10n', 'urls', 'utils', 'z'],
    ...
    var names = {
        ...
        descriptors: {
            ...
            usk: {
                // German.
                'abstract_violence': 'Abstrakte Gewalt',
                'alcohol': 'Alkoholkonsum',
                'discrimination': 'Diskriminierung',
                'drug_use': 'Drogenkonsum',
                'drugs': 'Drogen',
                'explicit_violence': 'Explizite Gewalt',
                'horror': 'Grusel/Horror',
                'lang': 'Explizite Sprache',
                'nudity': 'Nacktheit/Erotik',
                'scary': '\xC4ngstigende Inhalte',
                'sex_content': 'Erotik/Sexuelle Inhalte',
                'sex_ref': 'Sexuelle Andeutungen',
                'sex_violence': 'Sexuelle Gewalt',
                'sex_violence_ref': 'Andeutungen Sexueller Gewalt',
                'some_scares': 'Seltene Schreckmomente',
                'some_swearing': 'Gelegentliches Fluchen',
                'tobacco': 'Tabakkonsum',
                'violence': 'Gewalt',
            }
        },
